...
--
-- Host: localhost
-- Generation Time: 2019-01-06 08:30:55
-- 服务器版本： 5.7.18
-- PHP Version: 5.6.30
...
`user`,
`userName
`, `avatar`, `tempFilePath`, `content`, `create_time`, `review_id`, `duration`, `image`, `title`) VALUES
...
(11) NOT NULL AUTO_INCREMENT COMMENT '影评id', AUTO_INCREMENT=13;
COMMIT;
